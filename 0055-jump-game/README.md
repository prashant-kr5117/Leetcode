...
<pre style="background-color: rgb(193, 230, 198);"><strong>Input:</strong> nums = [2,3,1,1,4]
...
<pre style="background-color: rgb(193, 230, 198);"><strong>Input:</strong> nums = [3,2,1,0,4]
