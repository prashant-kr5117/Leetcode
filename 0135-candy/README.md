...
<pre style="background-color: rgb(193, 230, 198);"><strong>Input:</strong> ratings = [1,0,2]
...
<pre style="background-color: rgb(193, 230, 198);"><strong>Input:</strong> ratings = [1,2,2]
