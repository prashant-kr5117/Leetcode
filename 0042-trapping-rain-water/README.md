...
<pre style="background-color: rgb(193, 230, 198);"><strong>Input:</strong> height = [0,1,0,2,1,0,1,3,2,1,2,1]
...
<pre style="background-color: rgb(193, 230, 198);"><strong>Input:</strong> height = [4,2,0,3,2,5]
