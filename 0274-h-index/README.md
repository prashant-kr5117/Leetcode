...
<pre style="background-color: rgb(193, 230, 198);"><strong>Input:</strong> citations = [3,0,6,1,5]
...
<pre style="background-color: rgb(193, 230, 198);"><strong>Input:</strong> citations = [1,3,1]
