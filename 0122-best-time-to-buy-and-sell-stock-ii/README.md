...
<pre style="background-color: rgb(193, 230, 198);"><strong>Input:</strong> prices = [7,1,5,3,6,4]
...
<pre style="background-color: rgb(193, 230, 198);"><strong>Input:</strong> prices = [1,2,3,4,5]
...
<pre style="background-color: rgb(193, 230, 198);"><strong>Input:</strong> prices = [7,6,4,3,1]
